...
<!-- Заголовки -->
<c:set var="title" value='${isAdd ? "Добавление" : "Редактирование"} закупки' scope="request"/>
...
<div class="min-vh-100">
    <section class="w-25 mx-auto my-4 bg-light shadow-sm border rounded-3 p-3">
        <h4 class="text-center mb-4">${isAdd ? "Добавление" : "Редактирование"} закупки</h4>

        <form:form action='${pageContext.request.contextPath}/purchases/${isAdd ? "store" : "update"}'
                   mode="post"
                   modelAttribute="item">
            ...
            <div class="form-floating my-3">
                <form:input path="date" type="date" cssClass="form-control" required="required"
                            placeholder="_"/>
                <form:label path="date" cssClass="form-label">Дата закупки</form:label>
            </div>
            ...
            <div class="form-floating my-3">
                <form:input path="price" type="number" min="1" cssClass="form-control" required="required"
                            placeholder="_"/>
                <form:label path="price" cssClass="form-label">Цена закупки (&#8381;)</form:label>
            </div>
            ...
            <div class="mt-5 text-center">
                ...
                <a class="btn btn-secondary w-8rem" href="${pageContext.request.contextPath}/purchases">Назад</a>
            </div>
        </form:form>
    </section>
</div>
